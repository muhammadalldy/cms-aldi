...
$sql = "
	...
	WHERE ua.id='".$_GET['id']."'
";
$profile = $db->query($sql)->fetchArray();
		...
		<div class="content-wrapper">
			...
			<div class="content-inner">
				...
				<div class="profile-cover">
					<div class="profile-cover-img" style="background-image: url(../files/cover/<?=$profile['cover']?>)"></div>
					<div class="media align-items-center text-center text-lg-left flex-column flex-lg-row m-0">
						<div class="mr-lg-3 mb-2 mb-lg-0">
							<a href="#" class="profile-thumb">
								<img src="../files/image/<?=$profile['image']?>" class="border-white rounded-circle" width="48" height="48" alt="">
							</a>
						</div>

						<div class="media-body text-white">
				    		<h1 class="mb-0"><?=$profile['name']?></h1>
				    		<span class="d-block"><?=$profile['bio']?></span>
						</div>
								...
								<div class="modal-body">
					                        ...
					                        <div class="form-group">
					                        	<div class="row">
													...
													<div class="col-lg-12">
														<label>Bio</label>
														<textarea id="bio" name="bio" rows="3" cols="3" class="form-control" placeholder="Enter your bio"><?=$data['bio'];?></textarea>
													</div>
					                        	</div>
					                        </div>
