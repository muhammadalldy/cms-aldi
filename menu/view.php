						...
						<div class="col-md-12">
							...
							<div class="card">
								...
								<div class="card-body">
									 ...
									 <input type="hidden" name="txt01_id" value="<?=$_GET['id']?>">

										<div class="form-group">
											<label>Title:</label>
											<input type="text" name="txt01_title" value="<?=$data['title']?>" class="form-control" placeholder="Title" >
										</div>

										<div class="form-group">
											<label>File Name:</label>
											<input type="text" name="txt01_filename" value="<?=$data['filename']?>" class="form-control" placeholder="File name" >
										</div>

                                        <div class="form-group">
											<label>ID Parent:</label>
											<input type="number" name="txt01_id_parent" value="<?=$data['id_parent']?>" class="form-control" placeholder="ID Parent" >
										</div>

                                        <div class="form-group">
											<label>Ordering:</label>
											<input type="number" name="txt01_ordering" value="<?=$data['ordering']?>" class="form-control" placeholder="Ordering" >
										</div>


                                        <div class="form-group">
											<label>Icon:</label>
                                            <select name="txt01_icon" class="custom-select" >
                                        ...
                                        <div class="form-group">
											<label>Status:</label>
                                            <select name="txt01_is_active" class="custom-select" >
