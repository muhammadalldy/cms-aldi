...
if(isset($_POST["action"]) && $_POST["action"]=="submit_feed"){
  ...
  $db->query($sql);
   ...
   echo("<script>window.location.href = '../profile/index.php?id=".$_GET['id']."'; </script>");
}
				...
				<div class="content">
					...
					<div class="d-flex align-items-stretch align-items-lg-start flex-column flex-lg-row">
						...
						<div class="tab-content w-100 order-2 order-lg-1">
							...
							<div class="card">
								...
								<div class="card-body">
									<form action="../profile/index.php?id=<?=$_GET['id'];?>" method="post" enctype="multipart/form-data">
					...
					<div class="timeline timeline-left">
									...
									<div class="col-lg-12">
										<div class="card border-left-3 border-left-primary rounded-left-0">
											<div class="card-body" style="padding-bottom: 9px">
												...
												<div>
													<div>
														<h6><a href="#"><?=ucwords($data['name'])?></a></h6>
														<p>
						...
						<?php foreach ($subdatas as $subdata) {  ?>
							...
							<?php } else { ?>
								<span style="font-size: 11px; "><a href="../my_profile"><?=ucwords($subdata['name']);?></a> - <?=($subdata['content']);?><br/></span>
							<?php }  ?>
